...
let su = similar_user(dataset,'Jack Matthews', 3 ,pearson_correlation);
console.log("su", su);
...
let re = recommendation_eng(dataset,'Jack Matthews', pearson_correlation);
console.log("re", re);



// https://becominghuman.ai/introduction-to-recommendation-system-in-javascript-74209c7ff2f7
//https://github.com/jaimevalero/github-recommendation-engine
